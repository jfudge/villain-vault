"""
Django settings for villainsproject project.
...
ROOT_URLCONF = 'villainsproject.urls'
...
WSGI_APPLICATION = 'villainsproject.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'villainsproject/static'
]
